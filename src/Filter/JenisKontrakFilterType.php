...
/**
 * Description of App\Filter\JenisKontrakFilterType *
 */
class JenisKontrakFilterType extends AbstractFilterType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('no', Filters\TextFilterType::class, [
            'condition_pattern' => FilterOperands::STRING_CONTAINS
                ...
                ->add('nama_jenis_kontrak', Filters\TextFilterType::class, [
           'condition_pattern' => FilterOperands::STRING_CONTAINS
        ])
            ;
    }
